...
All notable changes to `@adopta/contracts` are documented here. Format loosely
follows [Keep a Changelog](https://keepachangelog.com/en/1.0.0/); versions are
bumped on any change to a schema, enum, constraint, procedure name, or error
code, per the governance rule in the repo README.
